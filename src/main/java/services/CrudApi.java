 ...
 public class CrudApi {
    ...
    //inicio de sesión en WP
     ...
     "utf-8"));
        ...
        // CRUD de Clientes
        public static void createClient(String name, String ci, String phone, String email) throws IOException {
               ...
               connection.setRequestProperty("Content-Type", "application/json");
               connection.setDoOutput(true);
                String jsonInputString = String.format("{\"name\": \"%s\", \"ci\": \"%s\", \"phone\":\"%s\", \"email\": \"%s\"}",
                name, ci, phone, email);
        try (OutputStream os = connection.getOutputStream()) {
            byte[] input = jsonInputString.getBytes("utf-8");
            os.write(input, 0, input.length);
     ...
     "utf-8"));
        ...
        public static void updateClient(String clientId, String name, String idCard, String phone, String email) throws IOException {
     ...
     public static void deleteClient(String clientId) throws IOException {
        URL url = new URL(base_url + "/wp-json/residencial/v1/clients/" + clientId);
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
    ...
    public static String listReceipts() throws IOException {
        URL url = new URL(base_url + "/wp-json/residencial/v1/receipts");
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        connection.setRequestMethod("GET");
        connection.setRequestProperty("Authorization", "Bearer " + token);
